...
- [MadeOnSol MCP](https://github.com/MadeOnSol/mcp-server-madeonsol) - MCP server for real-time Solana KOL wallet trade tracking, Pump.fun deployer reputation intelligence, and DEX-wide trade data. Free tier available, no payment required to start.
