...
- [Loophole Tape](https://api.loopholetape.com/) - x402 API and MCP server that returns pump.fun launch risk checks with calibrated rug and graduation probabilities, paid per call in USDC, with a free radar and public calibration tables.
