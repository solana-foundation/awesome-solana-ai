...
- [dexpaprika-api](https://github.com/coinpaprika/skills/tree/main/dexpaprika-api) - AI coding skill for DexPaprika API covering DEX data across 34 blockchains including Solana. Pools, tokens, OHLCV, trades, real-time SSE streaming, batch prices. Free, no API key. Also available as [MCP server](https://github.com/coinpaprika/dexpaprika-mcp) and [CLI](https://github.com/coinpaprika/dexpaprika-cli).
