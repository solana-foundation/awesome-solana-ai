...
- [prflght](https://github.com/prflght/prflght) - On-chain transaction firewall for AI agents on Solana: intercepts every agent transaction, simulates it, evaluates against a configurable policy DSL, checks live DeFi protocol health, and gates execution via a signed ed25519 attestation verified by the on-chain Anchor program.
