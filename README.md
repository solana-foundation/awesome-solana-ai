...
- [manifest-skill](https://github.com/sendaifun/skills/tree/main/skills/manifest) - AI coding skill for Manifest DEX covering orderbook trading, wrapper and global account setup, reverse orders, and SDK integrations on Solana.
