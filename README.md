...
- [KHAN](https://khanbot.fun) - Open-source autonomous AI agent that operates a transparent on-chain treasury on Solana: every fee claim, trade, and payout is executed on-chain and published to a public live log, with all agent code at github.com/CryptoGnome/khan.
