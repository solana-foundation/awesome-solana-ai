...
- [TrustBoost PII Sanitizer](https://github.com/teodorofodocrispin-cmyk/TrustBoost-PII-Sanitizer) - Blockchain-verified PII sanitization middleware for autonomous AI agents on Solana. Redacts emails, private keys, and passwords before text reaches LLMs. Trial mode available.
