...
- [AgentFolio](https://agentfolio.bot) - On-chain identity, reputation, and trust verification for AI agents on Solana via the SATP protocol (5 mainnet programs). 120+ registered agents with cross-platform verification (X, GitHub, Solana wallet). Includes an [MCP server](https://github.com/brainAI-bot/agentfolio-mcp-server) (`npx agentfolio-mcp-server`) and integrations for [LangChain](https://pypi.org/project/langchain-agentfolio/), [CrewAI](https://pypi.org/project/crewai-agentfolio/), [ElizaOS](https://www.npmjs.com/package/elizaos-agentfolio), and [5 more frameworks](https://github.com/brainAI-bot).
