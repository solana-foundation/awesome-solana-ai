...
- [Solana Agent](https://github.com/truemagic-coder/solana-agent) - Open-source AI framework and Solana toolkit in Python - build production-ready AI agents in three lines of code.
