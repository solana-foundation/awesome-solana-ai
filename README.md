...
- [DreamWidget](https://dreamwidget.com/guides/x402.html) - Website widget service an agent uses end to end: build a logo or video widget through the API and buy the plan by x402 in USDC on Solana, with the account and API key returned in the paid reply; OpenAPI, llms.txt and an x402 manifest published.
