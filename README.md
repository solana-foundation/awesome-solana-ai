...
- [defi-mcp](https://github.com/OzorOwn/defi-mcp) - MCP server for DeFi including Solana DEX swap quotes via Jupiter API, token prices, and multi-chain wallet balances.
