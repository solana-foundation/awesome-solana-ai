...
- [Droyd](https://droyd.ai) - Agent trading and skill network with one-click trading agent creation, API skills for crypto content search, trading, agent-to-agent x402 payments, and agent following.
