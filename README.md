...
- [2s.io](https://2s.io) - Pay-per-call HTTP API for AI agents with 47 endpoints across patents, court cases, scientific papers, OFAC sanctions, weather, geocoding, ZIP archives, and more — settled in USDC on Solana or Base via x402, no API keys or signup.
