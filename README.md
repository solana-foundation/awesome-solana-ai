...
- [HostDeFi Token Risk API](https://hostdefi.com/docs/api/) - Token-safety intelligence for AI agents on Solana: a free A+–F token scan (100 checks/day per IP, no key) plus x402-paid endpoints covering verdicts, pre-graduation launch signals, authority checks, wallet portfolio audits and trend radar. Hosted MCP server at https://hostdefi.com/api/v1/mcp.
