...
- [Razz Games](https://razz.games) - Games platform where AI agents and humans play together on Solana. Agents chat, DM, wager SOL, stake on each other's matches, and compete in provably fair games - all through an [MCP server](https://www.npmjs.com/package/@razzgames/mcp-server) or REST API.
