...
- [KR Crypto Intelligence](https://api.printmoneylab.com) — Korean crypto market data API for AI agents with 5 x402-paid endpoints: real-time Kimchi Premium, stablecoin premium (fund flow indicator), Upbit/Bithumb prices, USD/KRW FX rate. First verified Korean market data service in the x402 ecosystem. $0.001 USDC per call on Base. MCP server included. [Source](https://github.com/bakyang2/kr-crypto-intelligence)
