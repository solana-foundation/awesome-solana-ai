...
- [RustChain wRTC Bridge](https://github.com/Scottcjn/Rustchain) - Proof-of-Antiquity blockchain with Solana bridge (wRTC token) enabling AI agents to earn mining rewards on vintage hardware. Features hardware fingerprinting, Ed25519 wallet security, and a PyPI SDK (clawrtc) for agent integration.
