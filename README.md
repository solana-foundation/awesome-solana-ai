...
- [x402-solana-data](https://x402-solana-data.onrender.com) ([source](https://github.com/Sif-2/x402-solana-data)) - Real-time Solana trading data API for AI agents with 6 pay-per-request endpoints (trending, analysis, momentum, rug check, whales, snipe targets) via x402 USDC micropayments.
