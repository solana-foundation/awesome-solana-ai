...
- [manifest-skill](https://github.com/Bonasa-Tech/skills/tree/feat/manifest-skill/skills/manifest) - AI coding skill for Manifest DEX covering orderbook trading, wrapper and global account setup, reverse orders, and SDK integrations on Solana.
