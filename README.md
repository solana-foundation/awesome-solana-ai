...
- [Risk-Data API](https://tnt-audit.com/risk-api) - AI-powered risk scoring API for Solana tokens that returns a 0-100 safety score and detects insider wallet clusters (connected wallets controlling supply) missed by standard holder-distribution checks, built for AI trading agents and token screeners.
