...
- [pigeonhouse-skill](https://github.com/noegppgeon-boop/pigeonhouse-skill) - AI coding skill for PigeonHouse Protocol covering Token-2022 token launches on bonding curves, multi-quote trading, deflationary burn mechanics, Raydium CPMM graduation, and REST/Blinks API integration on Solana.
...
- [PigeonHouse Agent Kit Plugin](https://github.com/noegppgeon-boop/solana-agent-kit-plugin-pigeonhouse) - Solana Agent Kit V2 plugin enabling AI agents to create Token-2022 tokens, trade on bonding curves, and query burn analytics on PigeonHouse.
