...
- [WalletPrint](https://github.com/Loai17/walletprint-sdk) - Behavioral risk scoring SDK for agent wallets that flags anomalies before transactions are signed using wallet behavioral history. Integrates with ZeroDev, LangChain, and Coinbase AgentKit. Free tier, open source.
