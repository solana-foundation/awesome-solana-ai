...
- [Solblade](https://github.com/nullxnothing/solblade) - AI-native Solana wallet CLI with a built-in MCP server that gives AI agents scoped wallet access with per-wallet spend limits, rate caps, and destination allowlists. Features encrypted local keystore, Jupiter swaps, rent reclaim scanner, and tamper-evident audit logging.
