...
- [Unbrowse](https://github.com/unbrowse-ai/unbrowse) - Agent browser and universal API discovery tool that captures network traffic, reverse-engineers API endpoints from any website, and publishes reusable skills to a shared marketplace so every agent gets the fast path.
