...
- [solana-development-skill](https://github.com/tenequm/skills/tree/main/skills/solana-development) - Build Solana programs with Anchor or native Rust - covers accounts, CPIs, PDAs, token operations, testing with Bankrun/LiteSVM, and deployment workflows.
- [solana-security-skill](https://github.com/tenequm/skills/tree/main/skills/solana-security) - Audit Solana programs for common vulnerability patterns - missing signer/owner checks, PDA seed collisions, arithmetic overflows, and CPI exploits. Works with both Anchor and native Rust.
- [solana-compression-skill](https://github.com/tenequm/skills/tree/main/skills/solana-compression) - Build with ZK Compression via Light Protocol - compressed tokens and PDAs that skip rent, ideal for airdrops, loyalty points, and high-volume state.
