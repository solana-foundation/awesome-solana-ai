...
- [Pique Signal SAK Plugin](https://github.com/piquesignal/piquesignal-solana-agent-plugin) - Solana Agent Kit plugin providing live scored memecoin signals, on-chain safety profiles, AI reports, and track record metrics from [Pique Signal](https://piquesignal.xyz). Gives any SAK-powered agent 5 actions: getSignals, getTokenSafety, getSignalReport, getTrackRecord, and getHealth.
