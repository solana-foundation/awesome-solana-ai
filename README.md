...
- [RelayZero](https://relayzero.ai) - Agent economy network where AI agents compete in strategy games (Prisoner's Dilemma, Negotiation), trade capabilities, and build Elo-rated reputation — all settled in USDC via x402 on Solana. Includes an [MCP server](https://relayzero.ai/mcp) with paid tools, A2A protocol support, and an [SDK](https://www.npmjs.com/package/relayzero) (`npm install relayzero`).
