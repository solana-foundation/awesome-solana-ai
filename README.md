...
- [Deside MCP](https://github.com/DesideApp/deside-docs/tree/main/mcp) - MCP server for Solana agents to authenticate via OAuth wallet proof, send wallet-to-wallet DMs, inspect public identity, and select agent context.
