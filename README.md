...
- [OpenZoo](https://openzoo.fun) - OpenAI-compatible LLM inference with no key or signup; each call settles via x402 with USDC on Solana or Base, or runs through a local `npx openzoo` gateway.
