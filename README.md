...
- [The Agentcy](https://github.com/lightbrushproject/autonomous-prime-new) - MCP server fleet of 162 AI agents for Solana crypto intelligence — real-time Birdeye prices, Helius smart money tracking, Claude-powered market analysis, wallet generation, and x402 USDC micropayments. [Live server](https://the-agentcy-production.up.railway.app).
