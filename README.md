...
- [SURVIVOR Oracle](https://github.com/ayubeay/survivor-oracle) — Pay-per-call Solana token risk oracle with autonomous x402 payments. Detects promote-then-dump patterns and behavioral risk before capital deployment.
## Developer Tools
