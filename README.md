...
- [pigeonhouse-skill](https://github.com/noegppgeon-boop/pigeonhouse-skill) - AI coding skill for PigeonHouse Protocol covering Token-2022 token launches, bonding curve trading, and Raydium CPMM graduation.
...
- [PigeonHouse Agent Kit Plugin](https://github.com/noegppgeon-boop/solana-agent-kit-plugin-pigeonhouse) - Solana Agent Kit V2 plugin for launching tokens, trading on bonding curves, and querying analytics on PigeonHouse.
