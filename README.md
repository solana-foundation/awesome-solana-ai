...
- - [ClawPay](https://github.com/jakemeyer125-design/solana-agent-kit-clawpay) - Trustless on-chain escrow for AI agent-to-agent payments on Solana with auto-refund deadlines, stake-weighted dispute resolution, and a drop-in Solana Agent Kit plugin.
