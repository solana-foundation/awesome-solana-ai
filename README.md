...
- [Spraay Solana Gateway](https://github.com/plagtech/spraay-solana-gateway) - Batch payment gateway for AI agents on Solana. Send SOL or any SPL token to 1000+ wallets in one x402-powered API call. Streamable HTTP MCP server included. Live at gateway-solana.spraay.app. 
