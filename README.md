...
- [Pique Signal MCP](https://github.com/piquesignal/piquesignal-mcp) - MCP server for paper trading Solana memecoin signals in Claude Code. Pulls scored alerts from the Convergence Engine, executes simulated trades with confidence-based position sizing and risk limits, and tracks portfolio P&L with real-time Jupiter and DexScreener prices.
