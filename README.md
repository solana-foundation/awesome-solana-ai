...
- [Rendben](https://rendben.com/mcp) - Non-custodial USDC payment MCP server for Solana where agents inspect a checkout and receive unsigned transactions to sign client-side, settling 99.5% directly to the merchant's wallet and 0.5% + $0.18 in one atomic transaction.
