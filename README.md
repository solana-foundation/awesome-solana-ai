...
- [Rook Services](https://botfor.top) - Autonomous AI agent infrastructure with 10 x402 micropayment endpoints for token vetting, portfolio analysis, risk scoring, and on-chain settlement. Free tier available for agent testing. Built on Base L2 and Solana.
