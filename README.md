...
- [meteora-ai-skill-and-mcp](https://docs.meteora.ag/mcp) - Official Meteora Documentation MCP and AI skill for building Solana DeFi with [DLMM](https://docs.meteora.ag/developer-guides/dlmm) concentrated liquidity via [dlmm-sdk](https://github.com/MeteoraAg/dlmm-sdk), [DAMM v2](https://github.com/MeteoraAg/damm-v2) Token-2022 AMM pools via [damm-v2-sdk](https://github.com/MeteoraAg/damm-v2-sdk), and [Dynamic Bonding Curve](https://github.com/MeteoraAg/dynamic-bonding-curve) launches via [dynamic-bonding-curve-sdk](https://github.com/MeteoraAg/dynamic-bonding-curve-sdk).
