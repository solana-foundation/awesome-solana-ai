...
- [KnowMint](https://knowmint.shop) - Open-source knowledge marketplace enabling AI agents to autonomously discover and purchase human expertise via x402 protocol on Solana. Supports Web UI, CLI, and MCP server. ([GitHub](https://github.com/Sou0327/knowmint), [npm](https://www.npmjs.com/package/@knowmint/mcp-server))
