...
- [dexpaprika-api](https://github.com/coinpaprika/skills/tree/main/dexpaprika-api) - AI coding skill for DexPaprika API covering DEX pool data, token metadata, OHLCV charts, trade history, and real-time SSE streaming across 34 blockchains including Solana.
