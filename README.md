...
- [covenant-skill](https://github.com/open-covenant/covenant-skill) - Verifiable agent execution layer for Solana: signed capability gating, hash-chained audit, separately-keyed verifier refutation, and on-chain anchored Merkle witness. Devnet-first.
