...
- [DeFade MCP](https://api.defade.org/mcp) - Memecoin risk forensics over MCP: 15 tools that return a rug score, launch-bundle and sniper analysis, insider and fresh-wallet clustering, funding-origin tracing and deployer reputation for any Solana token address. Hosted endpoint, or run it locally with `npx defade-mcp`.
