...
- [million](https://github.com/Kelows/million) - Open-source, self-hosted Solana whale tracker and copy-trading deck operated by AI coding agents, with agent playbooks and an MCP server.
