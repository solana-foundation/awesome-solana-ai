...
- [Orbis API Marketplace](https://orbisapi.com) - x402 pay-per-call API marketplace with 2,000+ endpoints across finance, DeFi analytics, compute, and data. AI agents pay $0.001–$0.01 USDC per call on Solana or Base with no API key or signup required. Discover and call any endpoint autonomously — full catalog at [orbisapi.com/openapi.json](https://orbisapi.com/openapi.json).
