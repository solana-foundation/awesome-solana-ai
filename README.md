...
- [WZRD Protocol](https://twzrd.xyz) - Solana-native attention oracle and market layer that prices open-source AI velocity on HuggingFace, GitHub, and Artificial Analysis. Agents authenticate via Ed25519, deposit USDC into attention markets, and harvest CCM yield through gasless merkle claims. Includes a [TypeScript SDK](https://www.npmjs.com/package/@wzrd_sol/sdk), [Solana Agent Kit plugin](https://www.npmjs.com/package/@wzrd_sol/solana-agent-plugin), [ElizaOS plugin](https://www.npmjs.com/package/@wzrd_sol/eliza-plugin), [MCP server](https://app.twzrd.xyz/api/mcp) (18 tools), and [OpenAPI spec](https://twzrd.xyz/openapi.json).
