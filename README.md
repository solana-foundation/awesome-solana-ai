...
- [GROUNDTRUTH](https://github.com/groundtruth-now/groundtruth-mcp) - Recorded outcomes of Solana (pump.fun) memecoin launches and the track record of the wallets that launch them, for agents to check before they buy: coin records, a known-bad creator flag with its statistical basis, and time-to-rug, over MCP, x402 and a [Solana Agent Kit plugin](https://github.com/groundtruth-now/solana-agent-kit-plugin-groundtruth).
